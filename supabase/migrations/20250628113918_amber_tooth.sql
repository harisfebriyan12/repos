/*
  # Add Salary Payment Tracking System

  1. New Features
    - Add bank account information to profiles
    - Add payment status tracking to employee_salaries
    - Create salary_payments table for payment history
    - Add function to process salary payments with notifications
  ...
  2. Changes
    ...
    - Create new salary_payments table with complete payment tracking
    - Add indexes for better performance
    - Enable RLS with proper policies
    - Create process_salary_payment function
*/
