/*
  # Add Bank Account Information and Salary Payment Tracking

  1. New Columns
    - Add bank account fields to profiles table
    - Add payment status tracking to employee_salaries table

  2. New Tables
    - `salary_payments` table for tracking payment history

  3. Security
    - Enable RLS on salary_payments table
    - Add policies for salary payment access

  4. Functions
    - Function to process salary payments and send notifications
*/
